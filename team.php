  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid mb-0">
        <div class="container text-center">
            <h2 class="display-4">Our Teams</h2>
        </div>
    </div>
    <!--heading end-->
    <!--Mainbody start-->
            ...
            <div class="row">
                <div class="col-md-9">
                 <strong><div class="row">
                    <div class="col-md-4">
                    <img src="asset/img/ceo1.jpg" alt="" class="img-thumbnail" >
                    <p>CEO</p>
                         <p>Rabin K.C</p>
                         
                    </div>
                    <div class="col-md-4">
                    <img src="asset/img/GymManager.webp" alt="" class="img-thumbnail" >
                    <p>Exuective Manager</p>
                         <p>Harry</p>
                        
                    </div>
                    <div class="col-md-4">
                    <img src="asset/img/rece.jpg" alt="" class="img-thumbnail" >
                    <p>Receptionist</p>
                         <p>Krishna</p>
                    </div>
                 </div>
                 ...
                 <strong><div class="row">
                     <div class="col-md-4">
                     <img src="asset/img/trainer1.webp" alt="" class="img-thumbnail" >
                         <p>Trainer</p>
                         <p>Bijaya Shah</p>
                        
                     </div>
                     <div class=" col-md-4">
                     <img src="asset/img/trainer2.jpg" alt="" class="img-thumbnail" >
                         <p>Trainer</p>
                         <p>Shreeya</p>
                         
                     </div>
                     <div class="col-md-4">
                     <img src="asset/img/trainer3.jpg" alt="" class="img-thumbnail" >
                         <p>Trainer</p>
                         <p>Nitiya</p>
