  ...
  <body>
    ...
    <div class="container-fluid bg-white" style="padding: 40px;">
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    <strong>Gurus of Fitness</strong>
                    <p><i class="fa fa-map-marker"></i> Rapti-nagarpalika-10, Chitwan</p>
                    <p><i class="fa fa-phone-square"></i> 9865365265</p>
                    <p><i class="fa fa-envelope"></i> rabinchhatkuli11@gmail.com</p>
                    <p><i class="fa fa-globe"></i><a href="https://www.gurusoffitness.com.np"> www.gurusoffitness.com.np</a></p>
                    ...
                    {
                      $to='rabinchhatkuli@gmail.com';//your email
                      $name=$_POST['fname'];
                      $email=$_POST['email'];
